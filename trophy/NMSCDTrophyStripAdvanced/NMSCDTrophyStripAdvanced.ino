  ...
  httpServer.on("/", []()
                {
                  ...
                  modeOptions = modeOptions + "'orange': 2,";
                  modeOptions = modeOptions + "'yellow': 3,";
